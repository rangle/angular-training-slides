...
- Identifying accessibility challenges and how to overcome them will be the focus of the workshop
...
As you can see, a key way to test for it is to walk through a site with a screen reader
...
- Tabbing order is well covered on JetBlue
