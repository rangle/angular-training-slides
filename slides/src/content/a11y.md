...
- Example HTML developing a table:
...
- Use relative width and font sizing over absolutes
...
```
<a href="google.ca" target="blank" title="click this link to access Google.ca in a new window">
	access Google.ca
</a>
```
...
- E.g. a simple script in Jasmine to confirm ARIA roles are included by indicating a boolean response
- If you have
